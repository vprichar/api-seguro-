/**
* @preserve CanvasJS HTML5 & JavaScript Charts - v1.8.5 Beta 1 - http://canvasjs.com/ 
...
(function () {
	...
	Axis.prototype.createLabels = function () {
		...
		if (this.type === "axisX" && this.chart.plotInfo.axisXValueType === "dateTime") {
			...
			for (i = this._options.labelStep ? this.intervalStartPosition + labelInterval : this.intervalStartPosition; i <= endPoint; i = parseFloat((i + (labelInterval * labelSkipStep)).toFixed(14))) {
				var text = this.labelFormatter ? this.labelFormatter({ chart: this.chart._publicChartReference, axis: this._options, value: i, label: this.labels[i] ? this.labels[i] : null })
		...
		if (this.labelAutoFit || this._options.labelAutoFit) {
			if (this._position === "bottom" || this._position === "top") {
							...
							if (!isNullOrUndefined(this._options.labelWrap)) {//User has set Wrap (true/false)
								if (this._options.labelWrap) {//wrap is true -->Wrap
									...
									if (!isNullOrUndefined(this._options.labelMaxWidth)) {//User has set labelMaxWidth -->Clip after user set labelMaxWidth
										this.sessionVariables.labelMaxWidth = this._options.labelMaxWidth ? this._options.labelMaxWidth : labelMaxWidth = Math.min(Math.max(labelMaxWidth, labelWordMaxWidth), this.chart.width * 0.3);
										this.sessionVariables.labelAngle = this._options.labelMaxWidth > labelMaxWidth ? -25 : this.sessionVariables.labelAngle;
										this.sessionVariables.labelMaxHeight = labelMaxHeight;
										this.sessionVariables.labelWrap = this.labelWrap;
									}
										...
										this.sessionVariables.labelMaxWidth = Math.min(Math.max(labelMaxWidth, labelWordMaxWidth), this.chart.width * 0.3);
										this.sessionVariables.labelWrap = this.labelWrap;
										this.sessionVariables.labelMaxHeight = labelMaxHeight;
									}
								}
										...
										if (labelWordMaxWidth < labelMaxWidth) {
											if (adjacentLabelsWidth - (2 * labelMaxWidth) > labelOverlapWidth) {
												...
												if (adjacentLabelsWidth >= (2 * labelMaxWidth) && adjacentLabelsWidth < (2.2 * labelMaxWidth)) {//Reduce Font size											
													...
													this.sessionVariables.labelAngle = -25;
													this.sessionVariables.labelMaxWidth = Math.min(Math.max(labelWordMaxWidth, (labelMaxWidth * Math.cos(Math.PI / 180 * Math.abs(this.sessionVariables.labelAngle))) + ((labelMaxHeight - textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(this.sessionVariables.labelAngle)))), this.chart.width * 0.3);
													...
													this.sessionVariables.labelAngle = -25;
													this.sessionVariables.labelWrap = true;
													this.sessionVariables.labelMaxWidth = this.chart.height * 0.5;
													this.sessionVariables.labelFontSize = this.labelFontSize;
												}
											...
											if (labelIndex === i && ((labelWordMaxWidth + sizeNext.width) - (2 * labelMaxWidth) > labelOverlapWidth || ((labelWordMaxWidth + size.width) - (2 * labelMaxWidth) > labelOverlapWidth))) {
												labelOverlapWidth = (labelWordMaxWidth + sizeNext.width) - (2 * labelMaxWidth);
												this.sessionVariables.labelFontSize = isNullOrUndefined(this._options.labelFontSize) ? labelFontSize : this._options.labelFontSize;
												this.sessionVariables.labelWrap = true;
												this.sessionVariables.labelMaxWidth = Math.max(labelMaxWidth, labelWordMaxWidth);
												this.sessionVariables.labelAngle = -25;
				...
				var j = 0;
				var labelMaxWidth = isNullOrUndefined(this._options.labelMaxWidth) ? this.chart.width * .3 >> 0 : this._options.labelMaxWidth;
				if (!isNullOrUndefined(this.labelAngle)) {
					this.labelAngle = ((this.labelAngle % 360) + 360) % 360;
							...
							if (!isNullOrUndefined(this._options.labelWrap)) {//User has set Wrap (true/false)
								...
								if (!isNullOrUndefined(this._options.labelMaxWidth)) {//User has set labelMaxWidth -->Wrap if user set labelMaxWidth<labelMaxWidth else Rotate+Wrap
									...
									if (!isNullOrUndefined(sizeNext)) {
										...
										if (adjacentLabelsWidth - (2 * labelMaxHeight) > labelOverLapHeight) {
											labelOverLapHeight = adjacentLabelsHeight - (2 * labelMaxHeight);
											if (adjacentLabelsHeight >= (2 * this.labelMaxHeight) && adjacentLabelsHeight < (2.4 * this.labelMaxHeight)) {//Reduce Font size
												if (isNullOrUndefined(this._options.labelFontSize)) {
													if (this.labelFontSize > 12) {
											...
											else if (adjacentLabelsHeight >= (2.4 * this.labelMaxHeight) && adjacentLabelsHeight < (2.8 * this.labelMaxHeight)) {//Slant
												this.sessionVariables.labelAngle = -25;
												this.sessionVariables.labelMaxHeight = labelEffectiveMaxHeight;
												this.sessionVariables.labelFontSize = this.labelFontSize;
												this.sessionVariables.labelWrap = true;
											}
											else if (adjacentLabelsHeight >= (2.8 * this.labelMaxHeight) && adjacentLabelsHeight < (3.2 * this.labelMaxHeight)) {//Wrap+Reduce font size
												this.sessionVariables.labelMaxHeight = this.labelMaxHeight;
												this.sessionVariables.labelWrap = true;
												if (isNullOrUndefined(this._options.labelFontSize)) {
													if (this.labelFontSize > 12) {
											...
											else if (adjacentLabelsHeight >= (3.2 * this.labelMaxHeight) && adjacentLabelsHeight < (3.6 * this.labelMaxHeight)) {//Rotate+Wrap
												this.sessionVariables.labelAngle = -25;
												this.sessionVariables.labelMaxHeight = labelEffectiveMaxHeight;
												this.sessionVariables.labelWrap = true;
												this.sessionVariables.labelFontSize = this.labelFontSize;
											}
											else if (adjacentLabelsHeight > (3.6 * this.labelMaxHeight) && adjacentLabelsHeight < (10 * this.labelMaxHeight)) {
												if (isNullOrUndefined(this._options.labelFontSize)) {
													if (this.labelFontSize > 12) {
														this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize);
														size = textBlock.measureText();
											...
											else if (adjacentLabelsHeight > (10 * this.labelMaxHeight) && adjacentLabelsHeight < (50 * this.labelMaxHeight)) {
												if (isNullOrUndefined(this._options.labelFontSize)) {
													if (this.labelFontSize > 12) {
														this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize);
														size = textBlock.measureText();
	...
	CanvasJS.Chart.version = "v1.8.5 Beta 1";
